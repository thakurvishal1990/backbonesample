...
define([
  ...
  var initialize = function(options){
    ...
    router.on('route:defaultAction', function (actions) {
      require(['views/dashboard/btdashboard'], function (DashboardPage) {
        var dashboardPage = Vm.create(appView, 'DashboardPage', DashboardPage);
      });
    });
    router.on('route:landing', function (queryString) {
      require(['views/landing/btlanding'], function (LandingPage) {
        var landingPage = Vm.create(appView, 'LandingPage', LandingPage,{"tab" : queryString});
      });
    });
    router.on('route:appdetails', function () {
      //console.log(queryString);
      require(['views/appdetails/btappdetails'], function (AppDetailsPage) {
        var landingPage = Vm.create(appView, 'AppDetailsPage', AppDetailsPage);
      });
    });
